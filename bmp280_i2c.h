...
/**
  * @brief          BMP280 I2C initialization
  * @retval         void
  */
void bmp280_i2c_init();

/**
  * @brief          Read raw data from BMP280
  * @param[in]      fd: File descriptor 
  * @param[out]     *temp: Raw temperature data
  * @param[out]     *pressure: aw preessure data
  * @retval         void
  */
void bmp280_read_raw(int fd, int32_t *temp, int32_t *pressure);

/**
  * @brief          Sets calibration parameters for BMP280
  * @param[in]      fd: File descriptor 
  * @param[in]      bmp80_calib_param: structure with calibration data
  * @retval         void
  */
...
/**
  * @brief          Compensates raw temperature using calibration parameters
  * @param[in]      temp: Raw temperature 
  * @param[in]      bmp80_calib_param: structure with calibration data
  * @retval         int32_t
  */
...
/**
  * @brief          Compensates raw pressure using calibration parameters
  * @param[in]      pressure: Raw pressure
  * @param[in]      temp: Raw temperature  
  * @param[in]      bmp80_calib_param: Structure with calibration data
  * @retval         int32_t
  */
...
/**
  * @brief          Function to retrieve temperature and pressure
  * @retval         bmp280_i2c
  */
