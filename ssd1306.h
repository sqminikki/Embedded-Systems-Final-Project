...
/*Change to match the OLED Display*/
#define OLED_WIDTH 	                128
#define OLED_HEIGHT 	            64

/**
  *@brief       Function for initializing the OLED with default parameters
  *@param[in]   i2c_dev: i2c channel value
  *@retval      uint8_t   
  */
uint8_t ssd1306_system_init(uint8_t i2c_dev);

/**
  *@brief       Function for initializing the OLED i2c
  *@param[in]   i2c_dev: i2c channel value
  *@retval      uint8_t   
  */
...
/**
  *@brief       Disconnects OLED from i2c
  *@retval      uint8_t   
  */
uint8_t ssd1306_end();

/**
  *@brief       Function for turning on or off the OLED display
...
/**
  *@brief       Function for horizontally flipping the OLED data 
  *@param[in]   flip: 0 = normal, 1 = flipped
  *@retval      uint8_t   
  */
uint8_t ssd1306_oled_horizontal_flip(uint8_t flip);

/**
  *@brief       Function for vertically flipping the OLED data 
  *@param[in]   flip: 0 = normal, 1 = flipped
  *@retval      uint8_t   
  */
